...
## Settings
The config contains two important values you should overwrite in a local_config.py file.
...
The command shows you a password. In case you have forgotten the password, or locked yourself out with the 2FA function, this command will reset everything.
